...
export function MethodologySection() {
  ...
  return <section id="metodologia" className="py-20 bg-gradient-section">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          {steps.map((step, index) => <div key={index} className="flex flex-col md:flex-row items-center mb-12 last:mb-0">
              <div className="flex-shrink-0 w-24 h-24 rounded-full flex items-center justify-center mb-6 md:mb-0 md:mr-8 bg-purple-700">
